...
const skills = [
  ...
  { name: "Comunicacion", level: 85, color: "bg-[var(--unlok-green)]" },
  { name: "Liderazgo", level: 62, color: "bg-[var(--unlok-pink)]" },
  { name: "Trabajo en equipo", level: 90, color: "bg-[var(--unlok-cyan)]" },
]
...
const stats = [
  ...
  { label: "Entrevistas IA", value: "8", icon: GraduationCap },
      ...
      <Card className="glass-strong border-0 p-5 mb-6">
        <div className="flex items-center gap-4 mb-4">
          <div className="relative">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-[var(--unlok-pink)] flex items-center justify-center text-3xl font-bold text-white">
              C
            </div>
            <div className="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-[var(--unlok-green)] flex items-center justify-center text-xs font-bold text-white border-2 border-background">
              {level}
            </div>
          </div>
          <div className="flex-1">
            <h2 className="text-xl font-bold text-foreground">Carlos Martinez</h2>
            <p className="text-muted-foreground text-sm">@carlosm_unlok</p>
            <div className="flex items-center gap-2 mt-1">
              <Shield className="w-4 h-4 text-[var(--unlok-green)]" />
              <span className="text-sm text-[var(--unlok-green)] font-medium">Verificado</span>
            </div>
          </div>
        ...
        {/* Trust Score */}
        <div className="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-[var(--unlok-green)]/20 to-[var(--unlok-cyan)]/20">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-[var(--unlok-green)]/30 flex items-center justify-center">
              <TrendingUp className="w-6 h-6 text-[var(--unlok-green)]" />
            </div>
            <div>
          ...
          <div className="text-right">
            <span className="text-[var(--unlok-green)] text-sm font-medium">+12 esta semana</span>
