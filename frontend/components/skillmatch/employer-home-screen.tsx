  ...
  return (
    <div className="min-h-screen pb-24 safe-area-top">
      ...
      <div className="px-6 mb-6">
        ...
        >
          {[
            { label: "Por revisar", value: String(pendingCount), icon: ClipboardCheck, color: "#F59E0B" },
            { label: "Aceptados", value: String(acceptedCount), icon: UserCheck, color: "#10B981" },
            { label: "Total", value: String(EMPLOYER_CANDIDATES.length), icon: BarChart3, color: "#06B6D4" },
          ].map((stat) => (
            <div key={stat.label} className="glass rounded-xl p-3 text-center hover:bg-white/5 transition-colors">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[#94A3B8] text-sm">
                  Revisa reportes IA y acepta a quienes encajen
                </p>
              </div>
