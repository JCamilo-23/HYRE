      ...
      <div className="px-6 pt-6 pb-4">
        ...
        <div className="glass rounded-2xl p-6 relative">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#7C3AED] to-[#06B6D4] flex items-center justify-center text-3xl font-bold text-[#F1F5F9]">
              S
            </div>
            <div>
              <h2 className="text-xl font-semibold text-[#F1F5F9]">Sofia Martinez</h2>
              <p className="text-[#94A3B8] text-sm">Frontend Developer</p>
              <p className="text-[#475569] text-xs">Bogota, Colombia</p>
            </div>
          </div>
