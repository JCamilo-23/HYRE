    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 pb-24">
        <div className="text-center">
          <div className="w-20 h-20 rounded-full bg-[var(--unlok-green)]/20 flex items-center justify-center mx-auto mb-4">
            <Heart className="w-10 h-10 text-[var(--unlok-green)]" />
          </div>
    ...
    <div className="min-h-screen flex flex-col px-4 pt-6 pb-24 safe-area-top">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full glass">
          <Heart className="w-4 h-4 text-[var(--unlok-pink)]" />
          ...
          <Card className="glass-strong border-0 overflow-hidden">
            ...
            <div className={`h-40 bg-gradient-to-br ${company.gradient} relative`}>
              ...
              <motion.div
                ...
                className="absolute top-4 left-4 px-4 py-2 rounded-lg border-4 border-[var(--unlok-green)] bg-[var(--unlok-green)]/20 rotate-[-15deg]"
              >
                <span className="text-[var(--unlok-green)] font-bold text-xl">LIKE</span>
              </motion.div>
              <motion.div
      ...
      <div className="flex items-center justify-center gap-6 pt-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={handleLike}
          className="w-20 h-20 rounded-full bg-[var(--unlok-green)] flex items-center justify-center glow-accent"
        >
